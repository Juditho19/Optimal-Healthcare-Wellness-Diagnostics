const styles = {
  ...
  heading2: "text-2xl lg:text-3xl xl:text-4xl font-bold mb-4 text-navyBlue",
  heading3: "text-xl lg:text-2xl font-bold mb-2 text-deepBlue",
  bodyText: "text-sm md:text-base lg:text-lg",
  paragraph: "text-sm md:text-base lg:text-lg mb-4 text-gray-700 font-regular",
  ...
  // Cards
  whyCard: "flex flex-col items-center text-center border-2 border-skyBlue rounded-2xl shadow-xl p-8 flex-1 min-w-[280px] max-w-[350px]",
